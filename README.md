...
<br><b>1.3	LED</b>
<br>Led light connection: longer leg in Fig. 5 is linked to positive of 3.3 V and the short leg to ground. 
...
<br>Fig. 9 set the LED as digitalWrite as an output
<br>[OR: Blink the Photon on-board LED (D7) with the Particle App—Tinker screen. Tap D7 and make it in digitalWrite mode. Then tap the D7 circle, and the tiny blue LED on Photon should turn off or on.]
